...
STATIC_URL = '/static/'
# VNPAY CONFIG
VNPAY_RETURN_URL = 'http://localhost:8001/payment_return'  # get from config
VNPAY_PAYMENT_URL = 'https://sandbox.vnpayment.vn/paymentv2/vpcpay.html'  # get from config
VNPAY_API_URL = 'https://sandbox.vnpayment.vn/merchant_webapi/merchant.html'
VNPAY_TMN_CODE = 'NNU8SGDL'  # Website ID in VNPAY System, get from config
VNPAY_HASH_SECRET_KEY = 'HCOUPASBDEDZAVUHYYXERVCXFSNIQGNM'  # Secret key for create checksum,get from config
